program GridVclClientDatasetDemo;
...
uses
  ...
  VclDatasetDemoMain in 'VclDatasetDemoMain.pas' {VclDatasetDemoForm};
...
begin
  ...
  Application.CreateForm(TVclDatasetDemoForm, VclDatasetDemoForm);
  Application.Run;
end.
