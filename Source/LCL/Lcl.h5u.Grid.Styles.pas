...
function h5uGetLclPalette(ATheme: Th5uGridTheme): Th5uLclPalette;
  ...
  case ATheme of
    ...
    Th5uGridTheme.Modern:
      ...
      begin
        ...
        LText := ColorToRGB(clWindowText);
        LButton := ColorToRGB(clBtnFace);
        LHighlight := ColorToRGB(clHighlight);
        LHighlightText := ColorToRGB(clHighlightText);
        ...
        Result.HeaderText := ColorToRGB(clBtnText);
        ...
        Result.DisabledText := ColorToRGB(clGrayText);
        Result.ThumbHintBackground := ColorToRGB(clInfoBk);
        Result.ThumbHintText := ColorToRGB(clInfoText);
      end;
  end;
end;
