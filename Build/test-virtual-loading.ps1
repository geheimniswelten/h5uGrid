...
$taskSearch = @((Join-Path $taskRoot 'Source\Common'), (Join-Path $taskRoot 'Source\VCL'), (Join-Path $taskRoot 'Source\FMX'), $taskLib) -join ';'

Push-Location $PSScriptRoot
try {
    foreach ($taskTest in @('TestVclVirtualLoading', 'TestFmxVirtualLoading')) {
