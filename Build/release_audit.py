...
def check_factory_and_features() -> None:
    ...
    require_patterns(name, "Source/Common/h5u.Grid.Types.pas", [
        ...
        (r"Background:\s*TColor", "Standardfarbtyp in der Darstellung"),
    ])
    ...
    require_patterns(name, "Source/Common/h5u.Grid.Options.pas", [
        ...
        (r"RowSpacingColor.*?default\s+TColorRec\.Lightgray", "Row-Separatorfarbe"),
        (r"ColumnSpacingColor.*?default\s+TColorRec\.Lightgray", "Column-Separatorfarbe"),
        (r"ContentPaddingColor.*?default\s+TColorRec\.Lightgray", "Außenrandfarbe"),
        ...
        (r"constructor\s+Th5uGridSpacingOptions\.Create.*?FRowSpacingColor\s*:=\s*TColorRec\.Lightgray.*?FColumnSpacingColor\s*:=\s*TColorRec\.Lightgray.*?FContentPaddingColor\s*:=\s*TColorRec\.Lightgray", "Laufzeitdefaults der Separatorfarben"),
    ...
    require_patterns(name, "Source/Common/h5u.Grid.Columns.pas", [
        ...
        (r"constructor\s+Th5uGridColumn\.Create.*?FColor\s*:=\s*TColorRec\.SysDefault", "Column-Farbdefault"),
        (r"property\s+Color:\s*TColor", "Column-Farbe"),
    ...
    require_patterns(name, "Demos/VCL/ClientDataSet/Main.pas", [
        ...
        (r"\.Color\s*:=\s*\$00[0-9A-Fa-f]{6}", "VCL Column-Farbe"),
    ...
    require_patterns(name, "Demos/FMX/ClientDataSet/Main.pas", [
        ...
        (r"\.Color\s*:=\s*\$00[0-9A-Fa-f]{6}", "FMX Column-Farbe"),
